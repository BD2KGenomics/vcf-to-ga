...
_VARIANTSETMETADATA_INFOENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
_CALLSET_INFOENTRY.has_options = True
_CALLSET_INFOENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
_CALL_INFOENTRY.has_options = True
_CALL_INFOENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
_VARIANT_INFOENTRY.has_options = True
_VARIANT_INFOENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
